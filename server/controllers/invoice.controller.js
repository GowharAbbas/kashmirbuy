...
export const generateInvoice = async (req, res) => {
  try {
    ...
    /* ================= FOOTER NOTE ================= */
    doc.fontSize(11).fillColor("red").text("Important Note:", {
      underline: true,
    });
    ...
    doc
      .fontSize(11)
      .text(
        "Please ensure that the product is returned along with this invoice. Returns will not be accepted if the product is damaged, used, altered, mismatched, or if original tags, labels, or packaging have been removed.",
        { lineGap: 4 }
      );

    doc.moveDown(2);

    /* ================= CUT & PASTE PARCEL SECTION ================= */
    doc
      .fontSize(11)
      .text("------------------------------------------------------------");
