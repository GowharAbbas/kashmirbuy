...
import { createProduct, deleteProduct, getAllFeaturedProducts, getAllProducts, getAllProductsByCatId, getAllProductsByCatName, getAllProductsByPrice, getAllProductsByRating, getAllProductsBySubCatId, getAllProductsBySubCatName, getAllProductsByThirdSubCatName, getAllProductsByThirSubdCatId, getLatestProducts, getProduct, getProductsCount, removeImageFromCloudinary, searchProduct, updateProduct, uploadImages } from '../controllers/product.controller.js';

const productRouter = Router();

//productRouter.post('/uploadImages',auth,upload.array('images'),uploadImages);

productRouter.post('/uploadImages', auth, uploadImages);
...
productRouter.get('/getAllProductsByThirdSubCatId/:id',getAllProductsByThirSubdCatId);
